...
public class Capability {
	...
	public AppiumDriverLocalService startServer() {
		...
		service = AppiumDriverLocalService.buildService(new AppiumServiceBuilder()
                ...
                .withAppiumJS(new File("C:\\Users\\SRIVIDYAGUPTA\\AppData\\Roaming\\npm\\node_modules\\appium\\build\\lib\\main.js"))
	...
	//this is socket program for checking the port is in use or not/if it is it will kill/else it will start
	...
	public static AndroidDriver<AndroidElement> capabilities(String appPackage,String appActivity,String platformName,String deviceName,String chromeExecutable) throws IOException, InterruptedException {
		...
		pro.load(fis);
		 ...
		 if (deviceName.contains("Pixel3a")) {
			 startEmulator();
		 }
